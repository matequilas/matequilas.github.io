                        ...
                        <?php
                            try {
                                if($_SESSION['nivel'] == 0) {
                                  ...
                                  $sql = "SELECT documentos.id AS id, documentos.id_admin AS id_admin, documentos.nombre AS archivo, documentos.url AS url, admins.nombre AS usuario, documentos.creado AS creado FROM documentos INNER JOIN admins ON documentos.id_admin = admins.id_admin";
                                }
                            ...
                            while($documento = $resultado->fetch_assoc() ) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $documento['creado'];  ?></td>
                                    <?php } ?>
                                    <td>
